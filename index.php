...
<div class="container mt-5">
    ...
    <h1>Trabajo final BD1 - Compraventa de vehículos DIANSA</h1>
    ...
    <div class="modelo">
        <h2>Modelo E-R </h2>
        <p></p>
        <img src="entidadrelacion.png">
    </div>

    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="cliente/cliente.php">Entidad análoga a CASILLERO (TRANSACCIÓN)</a></li>
            <li><a href="empresa/empresa.php">Entidad análoga a CLIENTE (CLIENTE)</a></li>
